...
RSpec.describe User, type: :model do
  ...
  context 'Input validation' do
      ...
      new_user_one = User.create(username: 'my_username', first_name: 'first', last_name: 'last', email: 'myemail@gmail.com')  
      new_user_two = User.create(username: 'my_username', first_name: 'first', last_name: 'last', email: 'myemail@gmail.com') 
